...
class Ble extends Component {
  ...
  */
  ...
  sendDataToServer = async (value, coilOne, coilTwo, id) => {
    try {
      let config = {
        method: 'POST',
        headers: {
                        ...
                        if (this.state.status && this.dataFlag) {
                          if (value !== null) {
                            ...
                            for (const row of existingData) {
                              ...
                              this.sendDataToServer(row.voltage, row.coilOneData, row.coilTwoData, row.id)
                            }
                            ...
                            this.sendDataToServer(this.state.dataDoubleVoltage, this.state.dataDoubleVoltageCoilOne, this.state.dataDoubleVoltageCoilTwo, this.state.userID)
                            this.removeItemValue()
